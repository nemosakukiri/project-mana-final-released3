...
export default function App() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top Navigation Bar */}
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-outline-variant/20">
        <div className="max-w-screen-2xl mx-auto px-8 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold tracking-tight text-primary font-headline">Project Mana</div>
          
          <nav className="hidden md:flex items-center gap-8">
            <a href="#" className="text-on-surface-variant hover:text-primary transition-colors font-headline font-bold text-lg">ホーム</a>
            <a href="#" className="text-on-surface-variant hover:text-primary transition-colors font-headline font-bold text-lg">不作為DB</a>
            <a href="#" className="text-on-surface-variant hover:text-primary transition-colors font-headline font-bold text-lg">不祥事DB</a>
            <a href="#" className="text-secondary border-b-2 border-secondary pb-1 font-headline font-bold text-lg">公文書ライブラリ</a>
          </nav>

          <div className="flex items-center gap-4">
            <button className="p-2 hover:bg-surface-container-low rounded-md transition-all active:scale-95">
